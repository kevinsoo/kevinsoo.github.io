...
# load polling data
load(file="files/how-wrong-were-the-polls/election.Rda")
load(file="files/how-wrong-were-the-polls/polls.Rda")
...
## Error in popular-vote support for each candidate
...
## Popular-vote share over the (long) campaign
